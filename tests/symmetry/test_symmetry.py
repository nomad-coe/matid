...
@pytest.mark.parametrize(
    "system, material_id_expected, wyckoff_sets_expected",
    [
        ...
        pytest.param(
            ...
            material_id_mos2,
            wyckoff_sets_mos2,
            id="2D, non-flat, rotated",
        ),
        pytest.param(
            mos2_vacuum,
            material_id_mos2,
            wyckoff_sets_mos2,
            id="2D, non-flat, with vacuum",
        ),
        pytest.param(
            mos2_supercell,
            material_id_mos2,
            wyckoff_sets_mos2,
            id="2D, non-flat, supercell",
        ),
        pytest.param(
            graphene, material_id_graphene, wyckoff_sets_graphene, id="2D, flat."
        ),
        pytest.param(
            graphene_rotated,
            material_id_graphene,
            wyckoff_sets_graphene,
            id="2D, flat, rotated",
        ),
        pytest.param(
            create_si(cubic=True),
            material_id_si,
            wyckoff_sets_si,
            id="3D, cubic, silicon diamond",
        ),
        pytest.param(
            create_si(cubic=False),
            material_id_si,
            wyckoff_sets_si,
            id="3D, primitive, silicon diamond",
        ),
        pytest.param(
            create_fe(cubic=True),
            material_id_fe,
            wyckoff_sets_fe,
            id="3D, cubic, iron BCC",
        ),
        pytest.param(
            create_fe(cubic=False),
            material_id_fe,
            wyckoff_sets_fe,
            id="3D, primitive, iron BCC",
        ),
        pytest.param(
            create_sic(cubic=True),
            material_id_sic,
            wyckoff_sets_sic,
            id="3D, cubic, SiC zinc blende",
        ),
        pytest.param(
            create_sic(cubic=False),
            material_id_sic,
            wyckoff_sets_sic,
            id="3D, primitive, SiC zinc blende",
        ),
    ],
)
