...
atom with a gold impurity. SBC recovers the surrounding bulk as one 3D cluster
and leaves the lone impurity atom unclustered, since a single atom carries no
translational symmetry of its own.
"""
import os
