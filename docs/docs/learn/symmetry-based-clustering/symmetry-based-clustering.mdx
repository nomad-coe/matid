...
Head over to the [Gallery](/docs/learn/symmetry-based-clustering/gallery) to see
SBC applied to heterostructures, curved sheets with impurities, grain boundaries
and point defects, together with the source code to reproduce each example.