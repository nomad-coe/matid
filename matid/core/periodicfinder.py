...
class PeriodicFinder:
    ...
    def _find_new_seeds_and_cell(
        ...
        if seed_index is not None:
            ...
            matches, displacements = matid.geometry.get_matches_test(
                system,
                self.cell_list,
                seed_guesses,
            ...
            for match, displacement, seed_guess, multiplier, disloc, test_cell_index in zip(
                matches,
                displacements,
                seed_guesses,
                multipliers,
                ...
                # Store the cell basis vector. Note that the cell is updated if
                # a match was found.
                for i in range(3):
                    basis_mult = [0, 0, 0]
                    basis_mult[i] = 1
                    ...
                    if multiplier_tuple == basis_mult:
                        i_basis = disloc
                        # TODO: The displacement correction here seems to have a negative impact..?
                        # if match:
